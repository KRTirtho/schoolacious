...
function SchoolSectionMembers() {
  ...
  const { data: section, refetch } =
    useTitumirQuery<SectionSchemaWithSubject | null>(
  ...
  return (
    <VStack align="flex-start">
      <HStack overflowY="hidden" justify="space-between" w="full" pr="3">
        ...
        {section?.class_teacher && (
          <Text fontWeight="bold">{class_teacher}</Text>
        )}
      </HStack>
                ...
                <Td>
                  <HStack>
                    ...
                    <AddUserPopover
                      ...
                      roles={[USER_ROLE.teacher, USER_ROLE.classTeacher]}
                    />
                  </HStack>
                </Td>
              </Tr>
